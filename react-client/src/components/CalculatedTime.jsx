    ...
    return (
      <div className={styles.calculations}>
        ...
        <div className={styles.calcColumns}>
          ...
          <SaveBtn timezones={this.props.timezones} times={[this.props.calculatedMoments[0].format('hh:mm A'), this.props.calculatedMoments[1].format('hh:mm A')]} newlySaved={this.props.newlySaved} savedMessage={this.props.savedMessage}/>
      </div>
    );
  }
}
